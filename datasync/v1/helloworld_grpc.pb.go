...
func (c *helloWorldServiceClient) HelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/datasync.v1.HelloWorldService/HelloWorld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorldService_HelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/datasync.v1.HelloWorldService/HelloWorld",
	}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "datasync.v1.HelloWorldService",
	...
	Metadata: "datasync/v1/helloworld.proto",
}
